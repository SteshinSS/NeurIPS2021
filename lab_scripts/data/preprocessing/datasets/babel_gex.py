...
INPUT_PATH = "data/raw/gex_atac/babel_gex.h5ad"
OUTPUT_PATH = "data/preprocessed/gex_atac/babel_gex.h5ad"
CONFIG = "configs/data/gex/babel.yaml"

logging.basicConfig(level=logging.INFO)
log = logging.getLogger("babel_gex")
