...
- Мы пока не загружаем датасеты в единое хранилище (скоро будем). Вместо этого мы пишем скрипт для скачивания. Если датасет было тяжело найти, мы загружаем его, например, на свой гугл диск.
